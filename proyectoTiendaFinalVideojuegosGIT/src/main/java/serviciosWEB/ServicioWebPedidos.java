...
public class ServicioWebPedidos {
	...
	public ResponseEntity<String> paso1(String nombre, String direccion, String provincia,String pais, String telefono, HttpServletRequest request) {
		String respuesta = "";
		servicioPedidos.procesarPaso1(nombre, direccion, provincia, pais, telefono, (Usuario)request.getSession().getAttribute("usuario"));
		respuesta = "ok";
	...
	public ResponseEntity<String> paso3(String observaciones, HttpServletRequest request) {
		...
		servicioPedidos.procesarPaso3(observaciones, usuario);
